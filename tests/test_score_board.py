...
class TestNoDeadStones(TestCase):
    ...
    def test_simple_chinese(self):
        ...
        self.assertEqual(10, result[sente.BLACK])
        self.assertEqual(17.5, result[sente.WHITE])
    ...
    def test_simple_japanese(self):
        ...
        self.assertEqual(sente.stone.WHITE, game.get_winner())
        self.assertEqual(4, result[sente.BLACK])
        self.assertEqual(10.5, result[sente.WHITE])
    ...
    def test_count_captured_stones_chinese(self):
        ...
        self.assertEqual(sente.stone.WHITE, game.get_winner())
        self.assertEqual(3, result[sente.BLACK])
        self.assertEqual(10.5, result[sente.WHITE])
    ...
    def test_count_captured_stones_japanese(self):
        ...
        self.assertEqual(sente.stone.WHITE, game.get_winner())
        self.assertEqual(0, result[sente.BLACK])
        self.assertEqual(6.5, result[sente.WHITE])
